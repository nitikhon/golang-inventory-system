...
import { User as UserIcon, Mail, Building, Calendar, PackageCheck, Clock, ShieldCheck, LogOut } from 'lucide-react'
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <StatCard icon={<PackageCheck className="text-emerald-500" />} label="Total Returned" value="12" />
                <StatCard icon={<ShieldCheck className="text-blue-500" />} label="Account Status" value="Active" />
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <InfoRow icon={<Calendar size={18} />} label="Member Since" value={formatDate(user?.created_at)} />
                </div>
            </div>
